...
$data=mysql_fetch_array(mysql_query("select * from toeic where id_toeic='$_GET[id]'")); 
?>
...
<div class="container">
<fieldset>
<legend>Add Toeic Data Question</legend>
<div class="main-agileits">
<!--form-stars-here-->
		<div class="form-w3-agile">
			<form name="f1" method="post" action="main.php?p=toeic-update"  enctype="multipart/form-data">
			<input type="hidden" name="id_toeic" value="<?php echo $data['id_toeic']?>">
				<label class="label">Toeic Type </label>
				<div class="form-sub-w3">
					<select name="jenis_toeic" required>
						<option value="<?php echo $data['jenis_toeic']?>"><?php echo $data['jenis_toeic']?></option>
